...
const backgroundImage = 'images/kids.jpg';
...
class _DevWidgetsState extends State<DevWidgets> {
  ...
  void _onIntroEnd(BuildContext context) {
    Navigator.of(
      context,
    ).pushReplacement(MaterialPageRoute(builder: (_) => const InstaExplore()));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Container(height: 150, width: 150, color: kPrimaryColor)
      //     .animate(
      //       delay: 1000.ms, // this delay only happens once at the very start
      //       onPlay: (controller) => controller.repeat(), // loop
      //     )
      //     .shimmer(duration: Duration(milliseconds: 2000)),

      // TEXT ANIMATE WIDGETS
      // SizedBox(
      //   width: 500.0,
      ...
      //     Expanded(
      //       child: const Text('Be', style: TextStyle(fontSize: 43.0))),
